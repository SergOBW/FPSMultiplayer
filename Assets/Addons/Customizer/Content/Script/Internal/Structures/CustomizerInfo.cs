...
namespace MFPS.Addon.Customizer
{
    ...
    public class ListCustomizer
    {
        ...
        public List<AttachInfo> Lasers = new List<AttachInfo>();
    }
    ...
    public class CustomizerAttachments
    {
        ...
        public List<CustomizerModelInfo> Lasers = new List<CustomizerModelInfo>();
        ...
        public void GetAttachmentInfo(string weapon)
        {
            ...
            {
                Lasers[i].Info = info.Attachments.Lasers[Lasers[i].ID];
            }
        }
        ...
        public void Apply(int[] array)
        {
            ...
            Lasers.ForEach(x => { SetActive(x.Model, false); });
            ...
            ActiveModelInList(Lasers, array[4]);
        }
