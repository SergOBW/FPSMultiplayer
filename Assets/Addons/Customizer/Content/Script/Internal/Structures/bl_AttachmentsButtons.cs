...
namespace MFPS.Addon.Customizer
{
    public class bl_AttachmentsButtons : MonoBehaviour
    {
        ...
        public bl_AttachButton LaserButton;
        ...
        public void Init(bl_Customizer customizer)
        {
            ...
            if (LaserButton != null && cacheCustomizer.Positions.LaserPosition != null)
                LaserButton.transform.position = cacheCustomizer.Positions.LaserPosition.position;
        ...
        public void Active(bool active)
        {
            ...
            if (LaserButton != null)
                LaserButton.GetComponent<Renderer>().enabled = active;
        }
        ...
        public void LookAt(Transform t)
        {
            ...
            if (LaserButton != null)
                LaserButton.transform.LookAt(t);
        }
