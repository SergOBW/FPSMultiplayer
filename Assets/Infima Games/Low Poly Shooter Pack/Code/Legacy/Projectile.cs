...
namespace InfimaGames.LowPolyShooterPack.Legacy
{
	public class Projectile : MonoBehaviour
	{
		...
		private void Start()
		{
			...
			Physics.IgnoreCollision(bl_GameManager.Instance.LocalPlayerReferences.playerCharacter.GetComponent<Collider>(),
		...
		public void SetupProjectile(BulletData bulletData)
		{
		...
		private void OnCollisionEnter(Collision collision)
		{
			...
			if (collision.transform.CompareTag("BodyPart") )
			{
				IMFPSDamageable damageable = collision.transform.GetComponent<IMFPSDamageable>();
				if (damageable != null)
				{
