...
namespace InfimaGames.LowPolyShooterPack
{
	...
	public sealed class Character : CharacterBehaviour
	{
		...
		{
			return axisMovement.y > 0 || axisMovement.x > 0;
		}
		...
		private bl_PlayerNetwork _blPlayerNetwork;
		private PlayerFPState FPState;
		...
		void DetermineUpperState()
		{
			...
			else if (movementBehaviour.GetPlayerState() == PlayerState.Running && !IsReloading() && !isFiring && !IsAiming())
			{
			...
			_blPlayerNetwork.FPState = FPState;
		}
	}
}