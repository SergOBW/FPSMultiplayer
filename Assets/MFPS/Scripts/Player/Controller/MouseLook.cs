...
namespace MFPS.PlayerController
{
    ...
    public class MouseLook : MouseLookBase
    {
        ...
        /// </summary>
        public override void UpdateLook(Transform character, Transform camera, Transform ladder = null)
        {
        ...
        /// 
        /// </summary>
        public void Move(float inputX, float inputY, Transform character, Transform camera, Transform ladder)
        {
            if (ladder == null)
            {
