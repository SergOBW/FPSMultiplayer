...
public class bl_WeaponAnimation : bl_WeaponAnimationBase
{
    ...
    void UpdateAnimated(PlayerState playerState)
    {
        ...
        {
            /*
            float speedPercentage = playerReferences.movementBehaviour.VelocityMagnitude / playerReferences.movementBehaviour.GetSpeedOnState(PlayerState.Running, true);
