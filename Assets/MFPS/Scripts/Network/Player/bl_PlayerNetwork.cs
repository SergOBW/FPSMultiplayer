...
public class bl_PlayerNetwork : bl_MonoBehaviour, IPunObservable
{
    ...
    public void OnPhotonSerializeView(PhotonStream stream, PhotonMessageInfo info)
    {
        ...
        // Be cearful Send must be at the same point as Recive
    ...
    void OnLocalPlayer()
    {
        ...
        PlayerReferences.playerAnimations.BodyState = fpControler.GetPlayerState();
        PlayerReferences.playerAnimations.IsGrounded = fpControler.IsGrounded();
        PlayerReferences.playerAnimations.Velocity = fpControler.GetVelocity();
    ...
    {
        Debug.Log($"Weapon block state change to: {blockState}");
    ...
    private MovementBehaviour fpControler => PlayerReferences.movementBehaviour;
